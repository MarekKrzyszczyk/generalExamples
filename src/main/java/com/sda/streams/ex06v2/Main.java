package com.sda.streams.ex06v2;
...
public class Main {
    public static void main(String[] args) {
        ...
        OptionalDouble optionalDouble = Arrays.stream(numbers).sorted().filter(value -> value > Arrays.stream(numbers).mapToDouble(value2 -> value2).average().getAsDouble()).limit(5).average();
